...
const Donate = () => {
    ...
    return (
        <>
            <Head>
            <title>Buy VAFs | Vegan AF</title>
            <meta charSet="utf-8" />
            <link rel="shortcut icon" href="/images/veganLogo.ico" sizes="144x144"/>
            <meta name="viewport" content="initial-scale=1.0, width=device-width" />
            </Head>

        <Typography className={classes.title} variant="h4" align="center">Buy VAFs</Typography>
        <Box className={classes.instructionsBox}>
        <Typography variant="body2" component="p" align="center">Contact us before sending any transactions. Click the coin and then address to copy the address to your clipboard.</Typography>
        </Box>
